        ...
        <div className='customizer'>
            ...
            <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
                ...
                >
                    ...
                    <Typography sx={{ color: 'text.secondary' }}>سفارشی سازی و پیش نمایش در لحظه</Typography>
                    <IconButton
                ...
                <PerfectScrollbar options={{ wheelPropagation: false }}>
                    <CustomizerSpacing className='customizer-body'>
                        ...
                        <Box sx={{ mb: 4 }}>
                            ...
                            >
                                <FormControlLabel value='default' label='پیش فرض' control={<Radio />} />
                                <FormControlLabel value='bordered' label='مرزدار' control={<Radio />} />
                            </RadioGroup>
                        </Box>

                        {/* Mode */}
                        <Box sx={{ mb: 4 }}>
                            <Typography>حالت</Typography>
                            <RadioGroup
                                row
                                value={mode}
                            ...
                            >
                                ...
                                <FormControlLabel value='dark' label='تاریک' control={<Radio />} />
                        ...
                        {/* Color Picker */}
                        <div>
                            <Typography sx={{ mb: 2.5 }}>رنگ اولیه</Typography>
                            <Box sx={{ display: 'flex' }}>
                                <ColorBox
                    ...
                    <CustomizerSpacing className='customizer-body'>
                        ...
                        <Box sx={{ mb: 4 }}>
                            ...
                            >
                                ...
                                <FormControlLabel value='boxed' label='جعبه دار' control={<Radio />} />
                            </RadioGroup>
                        </Box>

                        {/* AppBar */}
                        <Box sx={{ mb: 4 }}>
                            <Typography>نوع نوار برنامه</Typography>
                            <RadioGroup
                                row
                                value={appBar}
                                ...
                                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
                            >
                                <FormControlLabel value='fixed' label='تنظیم شده' control={<Radio />} />
                        ...
                        {/* Footer */}
                        <Box sx={{ mb: 4 }}>
                            <Typography>نوع پاورقی</Typography>
                            <RadioGroup
                                row
                                value={footer}
                        ...
                        <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Typography>تاری نوار برنامه</Typography>
                            <Switch
                                name='appBarBlur'
                                checked={appBarBlur}
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Typography>راست چین</Typography>
                            <Switch
                                name='direction'
                    ...
                    <CustomizerSpacing className='customizer-body'>
                        ...
                        <Box sx={{ mb: layout === 'horizontal' && appBar === 'hidden' ? {} : 4 }}>
                            <Typography>لایه بندی منو</Typography>
                            <RadioGroup
                                row
                                value={layout}
                                onChange={e => {
                        ...
                        {navHidden || layout === 'horizontal' ? null : (
                            <Box sx={{ mb: 4 }}>
                                ...
                                <RadioGroup
                                    ...
                                    sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
                                >
                                    <FormControlLabel value='accordion' label='آکاردئون' control={<Radio />} />
                                    <FormControlLabel value='collapse' label='جمع شده' control={<Radio />} />
                                </RadioGroup>
                            </Box>
                        )}
                        ...
                        {navHidden || layout === 'horizontal' ? null : (
                            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <Typography>جمع شدن منو</Typography>
                                <Switch
                                    name='navCollapsed'
